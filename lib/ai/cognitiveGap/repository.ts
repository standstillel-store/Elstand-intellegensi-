 ...
 */
export async function buildCognitiveGapReport(source: DecisionSource, symbol: string, memory: DecisionMemoryResult | null, constraintValidations: readonly ConstraintValidation[]): Promise<CognitiveGapReport | null> {
  ...
  return { source, symbol, familiarityEvidence, gaps };
}
