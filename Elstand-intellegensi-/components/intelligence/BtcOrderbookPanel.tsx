  ...
  return (
    <div className="rounded-xl border border-line bg-bg-raised p-4">
      ...
      {/* Mobile/tablet (<1024px): stacked — chart on top, price ladder
          ...
          Order Book (depth chart) — per Zhwan's sketch. Now rendered at
          every width (not just lg:) per Zhwan's ask for mobile to be
          identical to laptop/PC instead of a separate simplified stack —
          columns just get narrower on a phone instead of switching shape. */}
      <div className="grid grid-cols-[minmax(0,1fr)_minmax(0,1.6fr)_minmax(0,1.4fr)] gap-2 sm:gap-3">
        {/* Column 1 — Indicators */}
